...
CORS(app, supports_credentials=True, origins=["https://jwhitproductions.netlify.app/","http://localhost:5173", "http://127.0.0.1:5173"], allow_headers=["Content-Type", "Authorization"],)
...
def signin():
    ...
    if user and user.verify_password(password):
        ...
        return jsonify({'message': 'Sign-in successful!pip', 'token': token, 'user': user.to_dict()}), 200
